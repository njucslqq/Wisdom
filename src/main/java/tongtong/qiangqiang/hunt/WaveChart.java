...
import tongtong.qiangqiang.func.ListMapper;
...
import static tongtong.qiangqiang.hunt.WaveChart.Direction.DOWN;
import static tongtong.qiangqiang.hunt.WaveChart.Direction.MEDIUM;
import static tongtong.qiangqiang.hunt.WaveChart.Direction.UP;
...
public class WaveChart extends TradeBase {
    ...
    public WaveChart(List<Double> before, ListMapper map) {
        this.before = before;
